...
// extern void drawJuliaSet( int cX, int cY, int FRAME_WIDTH, int FRAME_HEIGHT, int16_t frame )
...
int main()
{
	...
	printf( "*****Print All*****\n" );
	printf( "Team 13\n" );
	printf( "10627105   Liwei Chiang\n" );
	printf( "10627106   Cheihlee Hung\n" );
	printf( "10627114   Lizhu Chen\n" );
	printf( "ID Summation = 31881325\n" );
	printf( "*****End Print*****\n" );
    */
	...
	else
	{
		for( cY=400 ; cY>=min_cY; cY = cY + cY_step ) {
			...
			drawJuliaSet( frame, cY, FRAME_WIDTH, FRAME_HEIGHT ) ;
